                    ...
                    <div className='space-y-8 text-center lg:text-left'>
                        <div className='space-y-6'>
                            ...
                            <p className='text-gray-600 text-lg lg:text-xl leading-relaxed max-w-2xl'>
                                Transform your emotions into the perfect soundtrack. Spotimood creates personalized playlists 
                                that match your mood, helping you explore and enhance your emotional wellbeing through music.
                            </p>
                        </div>
